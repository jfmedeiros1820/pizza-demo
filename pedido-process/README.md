...
1 - Configure Dependency Manager
2 - Configure properties
3 - Create Handle Pedido Route
4 - Create Reques Route
5 - Create Validate Payment Processor
6 - Process the Response and Pedido
7 - Create Pedido Processor
8 - Create Retry with DeadLetter
9 - Create processor to prepare failure
10 - Run and test Endpoint
...
You can then execute your native executable with: `./target/pedido-process-1.0.0-runner`
